...
Coord dxy3 = new Coord(-2,1,0);
Coord dxy4 = new Coord(-1,2,0);

Coord dxy5 = new Coord(2,-1,0);
Coord dxy6 = new Coord(1,-2,0);

Coord dxy7 = new Coord(-2,-1,0);
Coord dxy8 = new Coord(-1,-2,0);
...
Coord dxz3 = new Coord(-2,0,1);
Coord dxz4 = new Coord(-1,0,2);

Coord dxz5 = new Coord(2,0,-1);
Coord dxz6 = new Coord(1,0,-2);

Coord dxz7 = new Coord(-2,0,-1);
Coord dxz8 = new Coord(-1,0,-2);
...
Coord dyz3 = new Coord(0,-2,1);
Coord dyz4 = new Coord(0,-1,2);

Coord dyz5 = new Coord(0,2,-1);
Coord dyz6 = new Coord(0,1,-2);

Coord dyz7 = new Coord(0,-2,-1);
Coord dyz8 = new Coord(0,-1,-2);
...
void runRule() {
  ...
  switch(phase) {
    case 0:
      ...
      busybox(cells, dxy3, dxy4);
      busybox(cells, dxy5, dxy6);
      busybox(cells, dxy7, dxy8);
      break;
    case 1:
      busybox(cells, dyz1, dyz2);
      busybox(cells, dyz3, dyz4);
      busybox(cells, dyz5, dyz6);
      busybox(cells, dyz7, dyz8);
      break;
    case 2:
      busybox(cells, dxz1, dxz2);
      busybox(cells, dxz3, dxz4);
      busybox(cells, dxz5, dxz6);
      busybox(cells, dxz7, dxz8);
      break;
    case 3:
      busybox(cells, dxy1, dxy2);
      busybox(cells, dxy3, dxy4);
